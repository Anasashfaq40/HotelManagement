...
function dlabSettings({
    ...
    this.typography = a || "poppins", this.version = t || "light", this.layout = r || "vertical", this.navheaderBg = e || "color_1", this.headerBg = o || "color_1", this.sidebarStyle = d || "full", this.sidebarBg = b || "color_1", this.sidebarPosition = i || "static", this.headerPosition = c || "static", this.containerLayout = s || "wide", this.direction = l || "ltr", this.primary = y || "color_1", this.manageTypography(), this.manageVersion(), this.manageLayout(), this.manageNavHeaderBg(), this.manageHeaderBg(), this.manageSidebarStyle(), this.manageSidebarBg(), this.manageSidebarPosition(), this.manageHeaderPosition(), this.manageContainerLayout(), this.manageRtlLayout(), this.manageResponsiveSidebar(), this.managePrimaryColor()
}
dlabSettings.prototype.manageVersion = function() {
    ...
    switch (this.sidebarStyle) {
        ...
        case "modern":
            ...
            break;
        case "icon-hover":
            body.attr("data-sidebar-style", "icon-hover"), $(".dlabnav").hover(function() {
    ...
    a < 1024 && (body.attr("data-layout", "vertical"), body.attr("data-container", "wide")), a > 767 && a < 1024 && body.attr("data-sidebar-style", "mini"), a < 768 && body.attr("data-sidebar-style", "overlay")
